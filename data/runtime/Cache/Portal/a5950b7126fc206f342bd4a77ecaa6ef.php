<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
    ...
    <![endif]-->
	<link rel="icon" href="/think/tpl/simplebootx/Public/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/think/tpl/simplebootx/Public/images/favicon.ico" type="image/x-icon">
    <link href="/think/tpl/simplebootx/Public/simpleboot/themes/cmf/theme.min.css" rel="stylesheet">
    <link href="/think/tpl/simplebootx/Public/simpleboot/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/think/tpl/simplebootx/Public/simpleboot/font-awesome/4.2.0/css/font-awesome-ie7.min.css">
	<![endif]-->
	<link href="/think/tpl/simplebootx/Public/css/style.css" rel="stylesheet">
	<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/think/"><h4 style="font-size:20px;line-height: 29px;">电信资源共享平台</h4></a>
 ...
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
		...
		<ul class="nav pull-right" id="main-menu-user">
			<li class="dropdown user login">
	            ...
	            <img src="/think/tpl/simplebootx//Public/images/headicon.png" class="headicon"/>
          	...
          	<li class="dropdown user offline">
	            <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
	           		<img src="/think/tpl/simplebootx//Public/images/headicon.png" class="headicon"/>登录<b class="caret"></b>
	            </a>
	            <ul class="dropdown-menu pull-right">
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/think/tpl/simplebootx/Public/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
...
<?php echo hook('footer');?>
      <div id="footer">
        ...
        <p>
        Made by <a href="http://pusri.github.io">Pusri</a>
        <br/>
        版权所有<a href="http://www.hbut.com" target="_blank">湖北工业大学 电气与电子工程学院</a>
        </p>
      </div>
...
<!-- Le javascript
    ...
    <script src="/think/tpl/simplebootx/Public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
    <script src="/think/statics/js/frontend.js"></script>
	<script>
	$(function(){
...
<script src="/think/tpl/simplebootx/Public/js/slippry.min.js"></script>
<script>
$(function() {
